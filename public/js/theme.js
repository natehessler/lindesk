export class ThemeManager {
    ...
    setLightMode() {
        ...
        if (this.themeIcon) this.themeIcon.innerHTML = this.icons.light;
        if (this.themeText) this.themeText.textContent = 'Dark';
        localStorage.setItem('theme', 'light');
    }
    
    setDarkMode() {
        document.body.classList.remove('light-mode');
        if (this.themeIcon) this.themeIcon.innerHTML = this.icons.dark;
        if (this.themeText) this.themeText.textContent = 'Light';
