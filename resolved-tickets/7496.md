...
- Doc Update Link: [Doc Update Link](https://github.com/sourcegraph/sourcegraph/pull/35444)
...
1. Customer sees the migration error...:
   ...
   **Answer**: [Docs updated](https://github.com/sourcegraph/sourcegraph/pull/35444) to make sure that one searches https://github.com/sourcegraph/sourcegraph/tree/main/migrations/frontend _to the correct version_ i.e. replacing `/main` with, say, `3.34`.
